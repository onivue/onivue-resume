function LogoIcon({ className, ...props }) {
  return (
    ...
    <svg className={className || 'h-5 w-5'} viewBox="0 0 42 45" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        ...
        >
          ...
          <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_816_6" />
          <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_816_6" result="shape" />
        </filter>
        <filter
          id="filter1_d_816_6"
          x="4"
