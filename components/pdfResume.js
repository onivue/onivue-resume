      ...
      <View style={styles.sectionWrapper}>
        <View style={styles.section} wrap={false}>
          ...
          <Text>
            ...
            government employee who believes the government's #1 job is serving
            the people. By pairing the right people with the right messaging at
            the right time, the parks department and your local government can
            make the world a better place for everyone! I have met Joe Biden,
            and one day I will become the first female President of the United
            States.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View wrap={false}>
            ...
            <Text style={styles.sectionH3}>WISS St. Gallen | 2017 - 2019</Text>
          </View>
          <View wrap={false}>
