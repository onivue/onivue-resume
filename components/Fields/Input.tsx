...
const Input = forwardRef(
  (
    ...
    const styles = {
      text: {
        base: 'w-full rounded-md text-black shadow-md dark:bg-dark-200 dark:text-white',
        active: 'focus:ring-primary-300 focus:border-primary-200 focus:shadow-primary-200',
